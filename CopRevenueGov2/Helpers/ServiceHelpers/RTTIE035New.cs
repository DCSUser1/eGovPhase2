...
namespace CopRevenueGov2.Helpers
{
    public class RTTIE035New : CopRestServiceBase, ICopSoapService
    {
        ...
        private static COPXmlFactory.RTTIE035new.UOFORM __Fill(UOForm_RTTIE035_SrvRef.TT035E00Response_SMA _SMA, UOForm_RTTIE035_SrvRef.TT035E00Response_EUOL _EUOL, UOForm_RTTIE035_SrvRef.TT035E00Response_EAMTS _EAMTS, UOForm_RTTIE035_SrvRef.TT035E00Response_EUO3 _EUO3)
        {
            ...
            {
                fobj.UO_AMTS.MAX_TAX = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.VACANCY = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.EXEMPT = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.RESIDENTIAL = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.DELINQUENT = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.KOZ_CREDIT = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.TOTAL_DEDUCTIONS = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.PERIOD_TAX = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.DISCOUNT = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.TAX_DUE = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.INTEREST_PENALTY = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.TOTAL_DUE = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.FIXED_EXEMPTN = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.ADJUSTED_TAX = CopMvcUtil.ConvDigitToCurrency("0");
                fobj.UO_AMTS.DELINQUENT_TENANT_COUNT = CopMvcUtil.ConvDigitToDouble("0");
            }
            ...
            else
            {
                for (int i = 0; i < 10; i++)
                {
                    ...
                    fobj.UO3_PAGE[i].PROCESS_CODE = "";
                    fobj.UO3_PAGE[i].TENANT_NAME = "";
                    fobj.UO3_PAGE[i].TENANT_ID = "";
                    fobj.UO3_PAGE[i].ACCOUNT_ID = "";
                    fobj.UO3_PAGE[i].AMOUNT = "";
                }
            }
