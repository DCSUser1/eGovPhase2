...
using COPXmlFactory.RTTIE037_2016;
using System;
...
{
    public class RTTIE037_2016 : CopRestServiceBase, ICopSoapService
    {
        ...
        {
            COPXmlFactory.RTTIE037_2016.BPTezReturn xo;

            try
            {
                xo = RevenueGovXMLFactory.GetObject<COPXmlFactory.RTTIE037_2016.BPTezReturn>(
                    Request);
            ...
            {
                xo =
                    RevenueGovXMLFactory.GetBPTez_2016Return();
        ...
        {
            COPXmlFactory.RTTIE037_2016.BPTezReturn acct;

            try
            {
                string InnerXML = Request.InnerXml;
                acct = RevenueGovXMLFactory.GetObject<COPXmlFactory.RTTIE037_2016.BPTezReturn>(
                    InnerXML);
        ...
        private static COPXmlFactory.RTTIE037_2016.BPTezReturn __RTTIE037_F_I(COPXmlFactory.RTTIE037_2016.BPTezReturn e)
        {
        ...
        private static COPXmlFactory.RTTIE037_2016.BPTezReturn __RTTIE037_F_U(COPXmlFactory.RTTIE037_2016.BPTezReturn e)
        {
            ...
            _EBPT.ACCOUNTID = e.BPT_INFO.ACCOUNT_ID;
            _EBPT.VERSIONX = e.BPT_INFO.VERSION;
            _EBPT.PERIODX = CopMvcUtil.ConvDateDecimalString(e.BPT_INFO.PERIOD);
            _EBPT.RETURNSTATUS = e.BPT_INFO.RETURN_STATUS;
            _EBPT.LASTUPDATEDATEX = CopMvcUtil.ConvDateDecimalString(e.BPT_INFO.LAST_UPD_DATE);
            _EBPT.RECORDINGDATEX = CopMvcUtil.ConvDateDecimalString(e.BPT_INFO.RECORDING_DATE);
            _EBPT.EXTENSIONDATEX = CopMvcUtil.ConvDateDecimalString(e.BPT_INFO.EXTENSION_DATE);
            _EBPT.SEQUENCENUM = e.BPT_INFO.SEQUENCE;
            _EBPT.ADJUSTMENTREFERENCENUM = e.BPT_INFO.ADJUSTMENT_REF_NO;
            _EBPT.USERID = e.BPT_INFO.USER_ID;
