...
using COPXmlFactory.RTTIE037_2014;
using System;
...
{
    public class RTTIE037_2014 : CopRestServiceBase, ICopSoapService
    {
        ...
        {
            COPXmlFactory.RTTIE037_2014.BPTezReturn xo;

            try
            {
                xo = RevenueGovXMLFactory.GetObject<COPXmlFactory.RTTIE037_2014.BPTezReturn>(
                    Request);
            ...
            {
                xo =
                    RevenueGovXMLFactory.GetBPTez_2014Return();
        ...
        {
            COPXmlFactory.RTTIE037_2014.BPTezReturn acct;

            try
            {
                string InnerXML = Request.InnerXml;
                acct = RevenueGovXMLFactory.GetObject<COPXmlFactory.RTTIE037_2014.BPTezReturn>(
                    InnerXML);
        ...
        {
            COPXmlFactory.RTTIE037_2014.BPTezReturn fobj = new BPTezReturn();
