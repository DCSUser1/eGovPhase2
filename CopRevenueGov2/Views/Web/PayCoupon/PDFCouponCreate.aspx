...
void OpenPayCouponTemplate()
{
    ...
    if (strVal == "ThankYou")
    {
        ...
        else
        {
            ...
            string st = File.ReadAllText(sPath + @"\Views\web\PayCoupon\PDFCouponImage.html");
            {
                sPayCouponTemplate = st;
            }
        }
    ...
    else
    {
        ...
        if (strAcctType == "27" || strAcctType == "84" || strAcctType == "85" || strAcctType == "09" || strAcctType == "11" || strAcctType == "18" || strAcctType == "90" || strAcctType == "91")
        {
            ...
            string st = File.ReadAllText(sPath + @"\Views\web\PayCoupon\PDFCouponImageTemplateDashboard.htm");
            {
                sPayCouponTemplate = st;
            }
        }
        ...
        {
            string st = File.ReadAllText(sPath + @"\Views\web\PayCoupon\PDFCouponImageDashboard.html");
            {
                sPayCouponTemplate = st;
            }
        }
