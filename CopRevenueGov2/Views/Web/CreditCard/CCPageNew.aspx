...
<head >
  <script type="text/javascript" language="javascript" >
      ...
      function DoCreditCard() {
          ...
          parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'NAME_ADDRESS ZIP', '', addrIdx), 'Customers Customer BillingAddress Address PostalCode', '', 0);
          ...
          if (typeof (AcctThankYou) !== 'undefined') {
            ...
            debugger;
            if ((parseInt(sCurrYear) - 1) == 2016 || (parseInt(sCurrYear) - 1) == 2015 || (parseInt(sCurrYear) - 1) == 2017) {
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '<%= COPSession.CC_NPT_ePay_ID %>', 'ApplicationID', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
                    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
                } else {
                    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
                }		//if Adjustment reference number
                a = parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO PERIOD', '', 0)
                //EGOVWEB-41
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'BillingDate', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'DueDate', '', 0)
                sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_PG1 TOTAL_DUE', '', 0), 0)).replace('$', '')
                if (sAmount == "") { sAmount = '0' }
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '<%= COPSession.CC_NPT_ePay_ID %>', 'ApplicationID', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_INFO ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_INFO ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
                if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
                    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_INFO ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
                } else {
                    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
                }		//if Adjustment reference number
                a = parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT_2015, 'NPT_INFO PERIOD', '', 0)
                ...
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'BillingDate', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'DueDate', '', 0)
                sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlNPT, 'NPT_PG1 TOTAL_DUE', '', 0), 0)).replace('$', '')
                if (sAmount == "") { sAmount = '0' }
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
                parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
	        ...
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
	        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
	            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
	        } else {
	            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
	        }		//if Adjustment reference number
	        a = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_INFO PERIOD', '', 0)
	        //EGOVWEB-41
	        ...
	        sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTez_2015, 'BPT_PG1 AMOUNT_OWED', '', 0), 0)).replace('$', '')
	        if (sAmount == "") { sAmount = '0' }
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
	    ...
	    else if ((parseInt(sCurrYear) - 1) == 2014) {
	        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '<%= COPSession.CC_BPT_ePay_ID %>', 'ApplicationID', '', 0)
    ...
    if ((sCurrYear - 1) == '2015' || (sCurrYear - 1) == '2016' || (sCurrYear - 1) == '2017') {
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '<%= COPSession.CC_BPT_ePay_ID %>', 'ApplicationID', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_INFO ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_INFO ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
        } else {
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
        }		//if Adjustment reference number
        a = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_INFO PERIOD', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'BillingDate', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'DueDate', '', 0)
        sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2015, 'BPT_PG1 AMOUNT_OWED', '', 0), 0)).replace('$', '')
        if (sAmount == "") { sAmount = '0' }
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
    ...
    if ((sCurrYear - 1) == '2014') {
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '<%= COPSession.CC_BPT_ePay_ID %>', 'ApplicationID', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
        if (parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0) != '') {
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
        } else {
            parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
        }		//if Adjustment reference number
        a = parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_INFO PERIOD', '', 0);
        ...
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'BillingDate', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'DueDate', '', 0)
        sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.xmlBPTlf_2014, 'BPT_PG1 AMOUNT_OWED', '', 0), 0)).replace('$', '')
        if (sAmount == "") { sAmount = '0' }
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
    ...
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.xmlAccount, 'UO_ACCT ACCOUNT_ID', '', 0), 'AccountNumber', '', 0)
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT ACCOUNT_ID', '', 0), 'BillNumber', '', 0)
    if (parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT ADJUSTMENT_REF_NO', '', 0) != '') {
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT ADJUSTMENT_REF_NO', '', 0), 'StatementNumber', '', 0)
    } else {
        parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT ACCOUNT_ID', '', 0), 'StatementNumber', '', 0)
    } 	//if Adjustment reference number
    a = parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT PERIOD', '', 0)
    //EGOVWEB-41
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, '84', 'OtherAttributes Attribute Value', '', 0)	//TaxType
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(0, 2), 'OtherAttributes Attribute Value', '', 1)	//TaxPeriod
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT PERIOD_YY', '', 0), 'OtherAttributes Attribute Value', '', 2)	//TaxYear


    //a = parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT RECORDING_DATE', '', 0)
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'BillingDate', '', 0)
    //a = parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_ACCT DUE_DATE', '', 0)
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, a.substr(6, 4) + '-' + a.substr(0, 2) + '-' + a.substr(3, 2), 'DueDate', '', 0)

    sAmount = ispStripCurrency(ispFormatMoney(parent.$x.ispXmlGetFieldVal(parent.$g.oUOFormNew, 'UO_AMTS TOTAL_DUE', '', 0), 0)).replace('$', '')
    if (sAmount == "") { sAmount = '0' }
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'ItemAmount', '', 0)
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalDue', '', 0)
    parent.$x.ispXmlSetFieldVal(parent.$g.xmlCC, sAmount, 'TotalAmountdue', '', 0)
...
<p>You can pay by American Express, Discover, MasterCard, VISA or eCheck. <label id="ccFeeText1">A 2.45% user fee will be added to the amount due when paying by credit card. E-check payments are free of charge. There will be a user fee of $5.95 when paying by VISA Debit Card or MasterCard Debit Card</label></p>
            <div class="clear"></div>
