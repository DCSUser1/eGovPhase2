        ...
        $(document).ready(function () {
            ...
            $(function () {
                $("#btnSubmit").click(function () {
                    $('#lblMessageW2AfterLogin').text('');
                    if ($('#fileToUpload').val() == "") {
                        $("#spanfileAfterlogin").html("Please upload file");
                        return false;
                    }
                    else {
                        debugger;
                        checkfile();
                        if (flag == true && $("#spanfileAfterlogin").text() == '') {
                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    ...
                                    $("#progressw2").hide();
                                    $("#progress-wrp").hide();
                                    $('#lblMessageW2AfterLogin').text('File uploaded successfully! Click Upload button to submit another file or Close X to exit.');
                                    //move();
                                    $('#fileToUpload').val('');
                                    $(progress_bar_id + " .progress-bar").css("width", "0%");
                                    $(progress_bar_id + " .status").text("0%");
                                    $("#progress-wrp").show();
                                    $('#divUploadW2AfterLogin').hide();
                                },                             
            ...
            function checkfile() {
                ...
                if (flag == false) {
                    $("#spanfileAfterlogin").text("You can upload only txt,docx,xlsx,pdf extension file");
                    return false;
                }
                else {                   
                    if ($("#fileToUpload").val()!= '') {
                        ...
                        if (size > 10000) {
                            $("#spanfileAfterlogin").text("You can upload file up to 1 GB");
                            return false;
                        }
                        else {
                            $("#spanfileAfterlogin").text("");
                        }
                    }
                }
            }
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%" class="text-left">
                                ...
                                <span class="field-validation-error" style="font-size:large" id="spanfileAfterlogin"></span>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td width="5%"></td>
                            <td width="94%" style="text-align:center;color:green;"><label id="lblMessageW2AfterLogin" style="font-size:16px"></label></td>
