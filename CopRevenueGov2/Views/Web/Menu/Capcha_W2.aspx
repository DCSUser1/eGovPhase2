...
<body >
   ...
   <div class="modal-dialog" style="margin-top:0px; width: 70%; height:100%;">
      <div class="modal-content" style="height:535px;">
        <div class="modal-header" style="background:#1B3C69; height:50px; border-radius:7px 7px 0 0;">
          ...
          <button type="button" class="close" onclick="CloseModalAfterlogin()" style="color:#fff; opacity:1; font-size:15px; margin-top:2px;"><span style="color:#fff;">Close X</span></button>
    </div>
	...
	<div class="modal-dialog" style="margin-top:0px; width:70%;">
       ...
       <div class="modal-header" style="background:#1B3C69; height:50px; border-radius:7px 7px 0 0;">
        ...
        <div class="modal-body">
          ...
          <h4>Captcha</h4>
             ...
             <%-- ================================Modal for W2 start=========================================--%>
              <% Html.RenderAction("UploadFile", "Menu"); %>
             <%-- ============================Modal for W2 end=============================================--%>
              </div>
          </div>
            <div class="clearfix"></div>
