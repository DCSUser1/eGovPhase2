...
<style>
    ...
    .UOSTYLE {
        font: 13px/20px Tahoma,'MS Sans Serif',Verdana,Arial;
    ...
    function ispMenu_onclick(mnuElement) {
        ...
        switch (mnuElement.id) {
            ...
            case 'mnuFilings':
                ...
                break;
            case 'mnuRulings':
                var a = window.open('https://beta.phila.gov/services/payments-assistance-taxes/regulations-rulings/', 'copdor');
                a.focus();
                break;
            case 'mnuFAQs':
        ...
        switch (mnuElement.id) {
            ...
            case 'mnuServices_a':
                ...
                if (document.getElementById('ifrmDocwin').contentWindow.location.href.search('Login/MainAsp') != -1) {
                    ...
                    if (mnuElement.id == 'mnuLogLogon') {
                        ...
                        document.getElementById('ifrmDocwin').contentWindow.HideForApplyFirst();
                    ...
                    else if (mnuElement.id == 'mnuLogElectronicPay') {
                        debugger;
                        //  parent.DocWin.ShowForm('LogCoupon');
                        EPaymt = 'TRUE';
            ...
            case 'mnuSchoolYear16':
            case 'mnuSchoolYear17':
            case 'mnuLCF':
            case 'mnuBPTlf':
            case 'mnuBPTlfYear09':
            case 'mnuBPTlfYear10':
            ...
            case 'mnuUO1':
                ...
                if ((mnuElement.id == 'mnuReSchool' || mnuElement.id.substr(0, 13) == 'mnuSchoolYear') &&
                    ...
                    else if (mnuElement.id == 'mnuSchoolYear16') {

                        sCurrReturnYear = '2017';		//Tax Year 2016
                    }
                    else if (mnuElement.id == 'mnuSchoolYear17') {

                        sCurrReturnYear = '2018';		//Tax Year 2016
                    }
                    ...
                    } else if (mnuElement.id == 'mnuWageYear16') {     //SumanG
                        sCurrReturnYear = '2017';		//Tax Year 2016 

                    }
                    else if (mnuElement.id == 'mnuWageYear17') {     //SumanG
                        sCurrReturnYear = '2018';		//Tax Year 2016 
                    ...
                    bFound = true;
                    // parent.NavWin.ClearImages();
                    if (mnuElement.id == 'mnuNPTYear17') {
                        sCurrReturnYear = '2018';		//Tax Year 2017	
                    }
                    if (mnuElement.id == 'mnuNPTYear16') {
                        sCurrReturnYear = '2017';		//Tax Year 2016	
                    }
                    ...
                    if (mnuElement.id == 'mnuBPTlfYear09') {
                        ...
                        sCurrReturnYear = '2016';		//Tax Year 2015
                    } else if (mnuElement.id == 'mnuBPTlfYear16') {
                        sCurrReturnYear = '2017';		//Tax Year 2015
                    }
                    else if (mnuElement.id == 'mnuBPTlfYear17') {
                        sCurrReturnYear = '2018';		//Tax Year 2015
                    }
                    ...
                    else if (mnuElement.id == 'mnuBPTezYear16') {    //SumanG
                        sCurrReturnYear = '2017';         // Tax Year 2016                       
                    }
                    else if (mnuElement.id == 'mnuBPTezYear17') {    //SumanG
                        sCurrReturnYear = '2018';         // Tax Year 2016                       
                    }
                    ...
                    else if (mnuElement.id == 'mnuTOBYear15') {
                        sCurrReturnYear = '2016';		//Tax Year 2014
                    }
                    else if (mnuElement.id == 'mnuTOBYear16') {
                        sCurrReturnYear = '2017';		//Tax Year 2014
                    }
                    else if (mnuElement.id == 'mnuTOBYear17') {
                        sCurrReturnYear = '2018';		//Tax Year 2014
                    }
                    ...
                    //parent.setFrameUrl('UO/UO2013Form');
        ...
        for (i = 0; i < a.length; i++) {
            ...
            if (a[i].id.indexOf('mnuWageYear') != -1 && GetNodeCount(parent.$g.xmlAccount, 'TAX_ACCT ACCOUNT', '1') == 1) {
                ...
                if (startDate != '' && '20' + a[i].id.slice(-2) < startDate) {
                    ...
                    $(a[i]).css("display", "none");//Changed by SumanG
                } else if (prkId != '' && '20' + a[i].id.slice(-2) > prkId) {
        ...
        <span id="spnMenu" onclick="ispMenu_onclick()">
            <div id="treeMenu" style="height:500px" >
                ...
                <ul class="nano-content">
                   ...
                   <%-- <li class="mnuNormal"><span id="mnuNew" class="closed statics tree-menu-alink">What's New</span></li>
                    <li class="mnuNormal"><span id="mnuTaxGuide" class="closed statics tree-menu-alink">Plain Talk Tax Guide</span></li>--%>
                    <li class="mnuNormal"><span id="mnuTaxForms" class="closed statics tree-menu-alink">Tax Forms & Instructions</span></li>
                     <li class="mnuNormal"><span id="mnuRulings" class="closed statics tree-menu-alink">Technical Rulings</span></li>
                    ...
                    <li class="mnuNormal"><span id="mnuLogPinChange" class="closed statics tree-menu-alink sub-static-menu-account">-  Pin Change</span></li>
                    <li class="mnuNormal"><span id="mnuLogPayCoupon" class="closed statics tree-menu-alink sub-static-menu-account">-  Payment Coupon</span></li>
                    </div>



                    <%--<li><span id="mnuServices" class="closed"><a id="mnuServices_a" class="parent submenu">Online Services Home</a></span>
                        <div style="display: block">
                            <ul id="divLogin">
                               
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogLogon">Account Log-In</span></li>
                                <li class="mnuNormal"><span id="lnkPIN" class="closed for_spacing" onclick="MainLinks(event)">Apply for a PIN</span></li>
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogNewAcct">Apply for an Account</span></li>
                                <li class="mnuNormal"><span id="lnkCoupon" class="closed for_spacing" style="background:none;" onclick="MainLinks(event)">Print a Payment Coupon</span></li>
                                <li class="mnuNormal"><span id="lnkEPaymt" class="closed for_spacing" style="background:none;" onclick="MainLinks(event)">Make an Electronic Payment</span></li>
                            </ul>
                            <ul id="divLogout">
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogLogout">Logout</span></li>
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogPinChange">Pin Change</span></li>
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogPayCoupon">Payment Coupon</span></li>
                               <%-- <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogElectronicPay">Electronic Payment</span></li>--%>
             ...
             <div  style="display: none; ">
                ...
                <li ><span class="closed for_spacing" id="mnuAcctECheck"> &nbsp;&nbsp;* E-Check</span></li> 
                    ...
                    <%-- 1/12/14 Sanghamitra:This portion is not needed--%>
                    <li id="mnuOnline" style="display: none;"><span class="closed" id="mnuAcctProfile_s"><a class="parent submenu" id="mnuAcctProfile">Taxpayer Information</a></span>
                    ...
                    <li style="display: none;" id="divPayments"><span class="closed" id="mnuTaxpayments_s"><a id="mnuTaxpayments_a" class="parent submenu">Tax Payments</a></span>
                        <div style="display: none;">
                            <ul>
                               <%-- <li class="mnuNormal"><span class="closed" id="mnuPayCurrent" style="display: none;">Current Payments</span></li>--%>
                                <%--<li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="">Current Payments</span></li>--%>
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuPayBalances">Outstanding Balances</span></li>
                                <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="mnuLogElectronicPay">Make Electronic Payment</span></li>
                                <%--<li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="">Payment History</span></li>--%>
                               <%-- <li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="">eCheck Payment</span></li>--%>
                                <%--<li class="mnuNormal"><span class="closed for_spacing" style="background:none;" id="">Payment Agreement</span></li>--%>
                    ...
                    <li id="divPayments1" style="display: none;"><span class="closed" id="mnuTaxfilling_s"><a id="mnuTaxfilling_a" class="parent submenu">Tax Filing Information</a></span>
                    ...
                    <li style="display: none;" id="divReturns"><span class="closed" id="mnuFileReturns_s"><a class="parent submenu" id="mnuFileReturn_a">Electronic Returns</a></span>
                        <div style="display: none;">
                            <ul>
                                <li id="mnuReWage" class="test"><span class="closed"><a href="#" class="parent">Wage</a></span>
                                    <div style="background: #666; display: none;">
                                        <ul class="bullet-list-type">
                                            <li id="mnuWageYear17" class="mnuNormal year_spacing">2017</li>
                                             <li id="mnuWageYear16" class="mnuNormal year_spacing">2016</li>
                                ...
                                <li id="mnuReSchool"><span class="closed"><a class="parent">School Income</a></span>
                                    <div style="background: #666; display: none;">
                                        <ul class="bullet-list-type">
                                             <li id="mnuSchoolYear17" class="mnuNormal year_spacing">2017</li>
                                            <li id="mnuSchoolYear16" class="mnuNormal year_spacing">2016</li>
                                    ...
                                    <div style="display: none; background: #666;">
                                        <ul class="bullet-list-type">
                                            <%--<li id="mnuBPTlfYear14" class="mnuNormal">2014</li>--%>
                                             <li id="mnuBPTlfYear17" class="mnuNormal year_spacing">2017</li> 
                                            <li id="mnuBPTlfYear16" class="mnuNormal year_spacing">2016</li>
                                ...
                                <li id="mnuReBPTez"><span class="closed"><a class="parent">Business Income and Receipts EZ</a></span>
                                    <div style="display: none; background: #666;">
                                        <ul class="bullet-list-type">
                                            <li id="mnuBPTezYear17" class="mnuNormal year_spacing">2017</li>
                                            <li id="mnuBPTezYear16" class="mnuNormal year_spacing">2016</li>
                                ...
                                <li id="mnuReNPT"><span class="closed"><a class="parent">Net Profit</a></span>
                                    <div style="display: none; background: #666;">
                                        <ul class="bullet-list-type">
                                            <li id="mnuNPTYear17" class="mnuNormal year_spacing">2017</li>
                                            <li id="mnuNPTYear16" class="mnuNormal year_spacing">2016</li>
                                ...
                                <li id="mnuTOB"><span class="closed"><a class="parent">Tobacco</a></span>
                                    <div style="display: none; background: #666;">
                                        <ul class="bullet-list-type">
                                            <li id="mnuTOBYear17" class="mnuNormal year_spacing">2017</li>
                                            <li id="mnuTOBYear16" class="mnuNormal year_spacing">2016</li>
                                            <li id="mnuTOBYear15" class="mnuNormal year_spacing">2015</li>
                               ...
                               <%-- <li id="mnuTOB"><span class="closed"><a class="parent">Earning</a></span>
                                    <div style="display: none; background: #666;">
                                        <ul class="bullet-list-type">
                                            <li id="mnuTOBYear15" class="mnuNormal year_spacing">2005</li>

                                        </ul>
                                    </div>
                                </li>--%>
                                
                                <li id="mnuUO" class="mnuNormal for_spacing1 UOSTYLE">Use & Occupancy</li> 

                            </ul>
                        </div>
                    </li>
                    <%--<li class="mnuNormal"><span id="mnuFilings" class="closed statics tree-menu-alink">Electronic Filing</span></li>--%>
                  <%--  <li class="mnuNormal"><span id="mnuRulings" class="closed statics tree-menu-alink">Technical Rulings</span></li>--%>
                   <%-- <li class="mnuNormal"><span id="lnkPIN" class="closed statics tree-menu-alink" onclick="MainLinks(event)">Apply for a PIN</span></li>--%>
                     <li class="mnuNormal" id="lnkNTLLI"><span id="lnkNTL" class="closed statics tree-menu-alink" onclick="MainLinks(event)">File a No Tax Liability</span></li>
                     <%--<li class="mnuNormal"><span id="lnkUpload" class="closed"><a id="A1" class="parent submenu">Upload your W2 & 1099 Forms</a></span>
                         <div id="divUpload" style="display: block; background: #666;">
                                        <ul class="bullet-list-type">
                                            <li id="lnkW2" class="mnuNormal year_spacing" onclick="MainLinks(event)">W2 form</li>
                                            <li id="lnk1099" class="mnuNormal year_spacing" onclick="MainLinks(event)">1099 form</li>
                    ...
                    <li class="mnuNormal" id="lnkUploadLI"><span id="lnkUpload" class="closed"><a id="A2" style="cursor:context-menu;" class="parent sub-static-menu-account-maintop">Upload your W2 & 1099 Forms</a></span></li>
                   <div id="divUpload">
                     <li class="mnuNormal"><span id="lnkW2" class="closed statics tree-menu-alink sub-static-menu-account" onclick="MainLinks(event)">-  W2 form</span></li>
                    <li class="mnuNormal"><span id="lnk1099" class="closed statics tree-menu-alink sub-static-menu-account sub-static-menu-account-last" onclick="MainLinks(event)">- 1099 form</span></li>
                    </div>
                </ul>
            </div>
