    ...
    <script id="clientEventHandlersJS" language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(function () {
                $("#btnSubmit1").click(function () {
                    ...
                    if ($('#fileToUpload1').val() == "") {
                        $("#spanfile1099Afterlogin").html("Please upload file");
                        return false;
                    }
                    else {
                        checkfile();
                        if (flag == true && $("#spanfile1099Afterlogin").text() == '') {
                           ...
                           // var url = "FileUploadHandler.ashx";
                            var url ='Menu/Upload_1099';
                            var progress_bar_1099_id = '#progress1099-wrp';
                            //$("#progress1099Afterlogin").show();
                            $.ajax({
                                url: url,
                                type: 'post',                                
                                contentType: false,
                                ...
                                success: function (result) {
                                    ...
                                    $("#progress1099Afterlogin").hide();
                                    $("#progress1099-wrp").hide();
                                    $('#lblMessage1099AfterLogin').text('File uploaded successfully! Click Upload button to submit another file or Close X to exit.');
                                    $('#fileToUpload1').val('');
            ...
            function checkfile() {
                ...
                if (flag == false) {
                    $("#spanfile1099Afterlogin").text("You can upload only txt,docx,xlsx,pdf extension file");
                    return false;
                }
                else {
                    if ($("#fileToUpload1").val() != '') {
                        ...
                        if (size > 10000) {
                            $("#spanfile1099Afterlogin").text("You can upload file up to 1 GB");
                            return false;
                        }
                        else {
    ...
    <div class="form-group">
        <div class="row table-responsive">
            <div class="col-lg-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%" class="text-left">
                                ...
                                <span class="field-validation-error" style="font-size:large" id="spanfile1099Afterlogin"></span>
                        ...
                        <tr>
                            <td width="5%"></td>
                            <td width="94%" style="text-align:center;color:green;"><label id="lblMessage1099AfterLogin" style="font-size:16px"></label></td>
                            <td colspan="2" width="1%"></td>
                        </tr>

                    </tbody>
                </table>
                <div id="divUpload1099AfterLogin">
                ...
                <span id="progress1099Afterlogin" style="display:none;text-align:center;margin-left:76px">
